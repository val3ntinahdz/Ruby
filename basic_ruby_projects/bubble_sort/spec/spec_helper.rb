...
RSpec.describe '#bubble_sort' do
  ...
  it 'functions with an empty array' do
    expect(bubble_sort([])).to eq([])
  end

  it 'functions with an array of one element' do
    expect(bubble_sort([1])).to eq([1])
  end

  it 'handles an array that is already sorted' do
    expect(bubble_sort([1, 2, 3, 4, 5])).to eq([1, 2, 3, 4, 5])
  end

  it 'handles an array that is reverse sorted' do
